...
The built-in file tools run outside composition, where ``huxerui::UseString``
...
# Prefixes of the migrated built-in file tool strings.
KEY_PREFIXES = ("tool_file_", "tool_glob_", "tool_list_dir_", "tool_call_action_")
...
// tool_call_action_* entries of resources/strings/default.properties (english)
